...
func TestCircleLinkedList(t *testing.T) {
	head := &CatNode{}
	insertCatNode(head, &CatNode{no: 1, name: "spark core"})
	insertCatNode(head, &CatNode{no: 2, name: "spark sql"})
	insertCatNode(head, &CatNode{no: 3, name: "spark streaming"})
	insertCatNode(head, &CatNode{no: 4, name: "spark mllib"})
	insertCatNode(head, &CatNode{no: 5, name: "spark graphx"})
